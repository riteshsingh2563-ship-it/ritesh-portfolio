...
const FALLBACK_DATA = {
  ...
  projects: [
    ...
    {
      id: "aura-app",
      title: "Aura Music — Open Source Player",
      category: "apps",
      ...
      features: ["100% Ad-free streaming & uninterrupted playback", "Direct high-quality music download for offline listening", "Background audio playback with lock screen media controls", "Open-source codebase with lightweight, battery-efficient design", "Clean dark-mode mobile interface with instant search"],
